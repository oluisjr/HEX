...
/* ── LOGIN PAGE — gradient covers full viewport ── */
/* App background — light for logged-in, dark gradient applied via .login-bg class */
.stApp { background: #f8fafc !important; }
[data-testid="stAppViewContainer"] { background: #f8fafc !important; }
.block-container { background: transparent !important; }

/* Login dark gradient — injected dynamically when on login page */
.login-bg-active .stApp,
.login-bg-active [data-testid="stAppViewContainer"],
/* Login styles now scoped inside page_login() */

/* Left side features */
.lf-row        { display: flex; align-items: center; gap: 14px; margin-bottom: 20px; }
...
.lf-mini-preview:hover { opacity: 1; transform: scale(1.05); }
...
def page_login():
    ...
    /* ── Glassmorphism card (iOS 26 liquid glass) ── */
    [data-testid="stColumn"]:nth-child(3)
    [data-testid="stVerticalBlockBorderWrapper"] {
        background           : rgba(8, 22, 50, 0.52) !important;
    ...
    /* ── Labels — light for glassmorphism ────────────── */
    ...
    [data-testid="stColumn"]:nth-child(3) input::placeholder {
    ...
    if current_user() is None:
        pass  # sidebar hidden at router level
    ...
    with left_col:
        ...
        <div style="padding: 6vh 16px 0 4px">
            ...
            <div class="lf-row"><div class="lf-icon-box">⚡</div><div style="flex:1">
            ...
            <div class="lf-mini-preview" title="Acesse: make.powerapps.com → Aplicativos → Novo app → Canvas">
              <svg width="88" height="56" viewBox="0 0 88 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="88" height="56" fill="#0a1628"/>
                <rect width="88" height="13" fill="#0d1f3c"/>
                <rect x="6" y="4" width="30" height="5" rx="2" fill="#60a5fa" opacity=".6"/>
                <rect x="40" y="4" width="16" height="5" rx="2" fill="#1e3a6e"/>
                <rect x="58" y="4" width="16" height="5" rx="2" fill="#1e3a6e"/>
                <rect x="2" y="14" width="20" height="40" fill="#07111f"/>
                <rect x="4" y="17" width="16" height="5" rx="1.5" fill="#1a3260"/>
                <rect x="4" y="24" width="16" height="5" rx="1.5" fill="#0078d4" opacity=".5"/>
                <rect x="4" y="31" width="16" height="5" rx="1.5" fill="#1a3260"/>
                <rect x="4" y="38" width="16" height="5" rx="1.5" fill="#1a3260"/>
                <rect x="4" y="45" width="16" height="5" rx="1.5" fill="#1a3260"/>
                <rect x="24" y="14" width="62" height="40" fill="#0f1f3a"/>
                <rect x="28" y="18" width="50" height="9" rx="2" fill="#1a2d50" stroke="#2a4070" stroke-width=".5"/>
                <rect x="28" y="29" width="23" height="7" rx="2" fill="#1a2d50" stroke="#2a4070" stroke-width=".5"/>
                <rect x="53" y="29" width="25" height="7" rx="2" fill="#1a2d50" stroke="#2a4070" stroke-width=".5"/>
                <rect x="28" y="38" width="18" height="10" rx="2.5" fill="#0078d4"/>
                <rect x="50" y="38" width="28" height="10" rx="2.5" fill="#1a2d50" stroke="#2a4070" stroke-width=".5"/>
              </svg>
            </div></div>
            <div class="lf-row"><div class="lf-icon-box">🔄</div><div style="flex:1">
            ...
            <div class="lf-mini-preview" title="Acesse: make.powerautomate.com → Criar → Flow automatizado">
              <svg width="88" height="56" viewBox="0 0 88 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="88" height="56" fill="#071a3e"/>
                <rect width="88" height="13" fill="#0a2252"/>
                <rect x="6" y="4" width="26" height="5" rx="2" fill="#60a5fa" opacity=".6"/>
                <rect x="36" y="4" width="14" height="5" rx="2" fill="#1a3870"/>
                <rect x="54" y="4" width="14" height="5" rx="2" fill="#1a3870"/>
                <rect x="18" y="15" width="52" height="9" rx="3" fill="#0f3080" stroke="#3b6ae0" stroke-width=".7"/>
                <rect x="28" y="17" width="10" height="5" rx="1.5" fill="#60a5fa" opacity=".4"/>
                <rect x="40" y="17" width="20" height="5" rx="1" fill="#60a5fa" opacity=".25"/>
                <line x1="44" y1="24" x2="44" y2="30" stroke="#3b6ae0" stroke-width="1.5"/>
                <polygon points="40,28 44,33 48,28" fill="#3b6ae0"/>
                <rect x="18" y="33" width="52" height="9" rx="3" fill="#0f3080" stroke="#3b6ae0" stroke-width=".7"/>
                <rect x="28" y="35" width="10" height="5" rx="1.5" fill="#60a5fa" opacity=".4"/>
                <rect x="40" y="35" width="20" height="5" rx="1" fill="#60a5fa" opacity=".25"/>
                <line x1="44" y1="42" x2="44" y2="47" stroke="#3b6ae0" stroke-width="1.5"/>
                <polygon points="40,45 44,50 48,45" fill="#3b6ae0"/>
                <rect x="24" y="49" width="40" height="6" rx="3" fill="#059669" opacity=".7"/>
              </svg>
            </div></div>
            <div class="lf-row"><div class="lf-icon-box">🤖</div><div style="flex:1">
            ...
            <div class="lf-mini-preview" title="Acesse: copilotstudio.microsoft.com → Criar → Copilot">
              <svg width="88" height="56" viewBox="0 0 88 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="88" height="56" fill="#150a2e"/>
                <rect width="88" height="13" fill="#1d1040"/>
                <rect x="6" y="4" width="30" height="5" rx="2" fill="#a78bfa" opacity=".6"/>
                <rect x="40" y="4" width="14" height="5" rx="2" fill="#2d1a5e"/>
                <rect x="2" y="14" width="22" height="40" fill="#0d071e"/>
                <rect x="4" y="17" width="18" height="4" rx="1.5" fill="#2d1a5e"/>
                <rect x="4" y="23" width="18" height="4" rx="1.5" fill="#6d28d9" opacity=".5"/>
                <rect x="4" y="29" width="18" height="4" rx="1.5" fill="#2d1a5e"/>
                <rect x="4" y="35" width="18" height="4" rx="1.5" fill="#2d1a5e"/>
                <rect x="26" y="14" width="60" height="40" fill="#110828"/>
                <rect x="30" y="17" width="32" height="8" rx="4" fill="#2d1a5e"/>
                <rect x="30" y="20" width="28" height="2" rx="1" fill="#7c3aed" opacity=".5"/>
                <rect x="36" y="27" width="38" height="8" rx="4" fill="#6d28d9" opacity=".5"/>
                <rect x="38" y="30" width="32" height="2" rx="1" fill="#a78bfa" opacity=".5"/>
                <rect x="30" y="37" width="34" height="8" rx="4" fill="#2d1a5e"/>
                <rect x="30" y="40" width="26" height="2" rx="1" fill="#7c3aed" opacity=".5"/>
                <rect x="28" y="47" width="48" height="5" rx="2" fill="#1e0f3d" stroke="#3b1d7a" stroke-width=".5"/>
              </svg>
            </div></div>
            <div class="lf-row"><div class="lf-icon-box">🗄️</div><div style="flex:1">
            ...
            <div class="lf-mini-preview" title="Acesse: make.powerapps.com → Tabelas → Nova tabela">
              <svg width="88" height="56" viewBox="0 0 88 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="88" height="56" fill="#071e1a"/>
                <rect width="88" height="13" fill="#0a2820"/>
                <rect x="6" y="4" width="26" height="5" rx="2" fill="#34d399" opacity=".6"/>
                <rect x="36" y="4" width="14" height="5" rx="2" fill="#104030"/>
                <rect x="54" y="4" width="20" height="5" rx="2" fill="#0d9488" opacity=".5"/>
                <rect x="2" y="14" width="84" height="8" fill="#0d2e28"/>
                <rect x="4" y="17" width="18" height="3" rx="1" fill="#34d399" opacity=".4"/>
                <rect x="25" y="17" width="18" height="3" rx="1" fill="#34d399" opacity=".4"/>
                <rect x="46" y="17" width="18" height="3" rx="1" fill="#34d399" opacity=".4"/>
                <rect x="67" y="17" width="16" height="3" rx="1" fill="#34d399" opacity=".4"/>
                <rect x="2" y="22" width="84" height="7" fill="#071e1a"/>
                <rect x="4" y="24" width="18" height="3" rx="1" fill="#64748b" opacity=".5"/>
                <rect x="25" y="24" width="18" height="3" rx="1" fill="#64748b" opacity=".5"/>
                <rect x="46" y="24" width="18" height="3" rx="1" fill="#64748b" opacity=".5"/>
                <rect x="67" y="24" width="16" height="3" rx="1" fill="#0d9488" opacity=".5"/>
                <rect x="2" y="29" width="84" height="7" fill="#0a2218"/>
                <rect x="4" y="31" width="18" height="3" rx="1" fill="#64748b" opacity=".5"/>
                <rect x="25" y="31" width="18" height="3" rx="1" fill="#64748b" opacity=".5"/>
                <rect x="46" y="31" width="18" height="3" rx="1" fill="#64748b" opacity=".5"/>
                <rect x="67" y="31" width="16" height="3" rx="1" fill="#0d9488" opacity=".5"/>
                <rect x="2" y="36" width="84" height="7" fill="#071e1a"/>
                <rect x="4" y="38" width="18" height="3" rx="1" fill="#64748b" opacity=".5"/>
                <rect x="25" y="38" width="18" height="3" rx="1" fill="#64748b" opacity=".5"/>
                <rect x="46" y="38" width="18" height="3" rx="1" fill="#64748b" opacity=".5"/>
                <rect x="67" y="38" width="16" height="3" rx="1" fill="#0d9488" opacity=".5"/>
                <rect x="2" y="43" width="84" height="7" fill="#0a2218"/>
                <rect x="4" y="45" width="18" height="3" rx="1" fill="#64748b" opacity=".5"/>
                <rect x="25" y="45" width="18" height="3" rx="1" fill="#64748b" opacity=".5"/>
                <rect x="46" y="45" width="18" height="3" rx="1" fill="#64748b" opacity=".5"/>
                <rect x="67" y="45" width="16" height="3" rx="1" fill="#0d9488" opacity=".5"/>
              </svg>
            </div></div>
        </div>
        """, unsafe_allow_html=True)
        ...
        with st.container(border=True):
            ...
            <div style="margin-bottom:24px">
                <div style="font-size:10px;font-weight:800;letter-spacing:2.5px;
                    ...
                    <span style="width:18px;height:2px;background:#ffffff;
                ...
                <div style="font-size:27px;font-weight:900;color:#ffffff;
                    ...
                    {title_txt}</div>
                <div style="font-size:13.5px;color:#ffffff;line-height:1.5">{sub_txt}</div>
            </div>
            """, unsafe_allow_html=True)
...
# ─────────────────────────────────────────────
if require_login():
    # ── Inject sidebar-hide on EVERY login rerun (prevents CSS stale-cache bug) ──
    st.markdown(
    ...
    # ── Explicitly show sidebar on every logged-in rerun ──
    st.markdown(
